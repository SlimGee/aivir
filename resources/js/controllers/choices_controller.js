      ...
      Object.assign(
        {
          classNames: {
            ...
            containerInner:
              "choices__inner border dark:border-zinc-700 rounded !p-1.5 !text-sm !mt-1".split(
                " ",
              ),
            input: "choices__input !p-1.5 form-input".split(" "),
            inputCloned:
              "choices__input--cloned dark:bg-zinc-800 !p-1.5 !border-none focus:!border-none focus:!ring-none".split(
                " ",
              ),
            list: "choices__list",
