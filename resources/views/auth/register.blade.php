                ...
                <div class='mx-auto w-full bg-white md:w-1/2 dark:bg-slate-800'>
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class='mt-3 text-sm text-slate-700 dark:text-slate-400'>
                            By creating an account you agree to our <a href="{{ route('pages.show', 'terms') }}"
                                class='font-bold text-purple-accent-400'>Terms
                                of Service</a> and
                            <a class='font-bold text-purple-accent-400'
                                href="{{ route('pages.show', 'privacy-policy') }}">Privacy Policy</a>
                        </div>
                    </form>
                </div>
            </div>
